          ...
          <div style={{ 
            ...
            <div 
              style={{
                ...
                padding: '10px',
                background: selectedMyCardIndex !== null ? 'rgba(255, 0, 0, 0.15)' : 'rgba(255,255,255,0.02)',
                border: selectedMyCardIndex !== null ? '2px dashed #ff4d4d' : '1px solid rgba(255,255,255,0.05)',
                borderRadius: '12px',
                transition: 'all 0.2s'
              }}
              onClick={() => {
                if (selectedMyCardIndex !== null) attackToLeader(selectedMyCardIndex);
              }}
            >
